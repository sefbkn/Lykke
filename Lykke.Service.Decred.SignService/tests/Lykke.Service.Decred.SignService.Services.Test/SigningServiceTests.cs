...
namespace Lykke.Service.Decred.SignService.Services.Test
{
    public class SigningServiceTests
    {
        private string[] _keys =
        {
            "PtWTdZuQXrRgH3GMEaAMv1oBgipQoBPRQD13oS27tBugrmS9SMe5N","PtWUfR8YXe4r8VGdmPpBTktkTXTLghX5yS5DE4Dy17qqHbXwvPDXW"
        };
